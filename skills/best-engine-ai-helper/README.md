...
2. Consults the bundled model catalog and ranks candidates by benchmark score within the
   available memory budget (80% headroom).
...
|----------|---------------|---------|
| `BEST_LLM_TEXT` | `qwen3-vl:72b` | Text model tag for Ollama |
| `BEST_LLM_VISION` | `qwen3-vl:72b` | Vision model tag for Ollama |
