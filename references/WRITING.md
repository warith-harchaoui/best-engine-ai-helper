...
- **Originality.** Does the point already exist as such in the common literature, or is
  it framed in a way with no accessible equivalent? A point wholly available elsewhere
  adds little; a framing, a series drawn together, a reformulation that illuminates, add
  much. A good reformulation is itself original work: the merit often lies in the angle,
  not the bare fact.
